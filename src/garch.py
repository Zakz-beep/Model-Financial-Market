...
================================================================
  ...
  Historical Analysis: April 13-17, 2026
...
def build_html_dashboard(hist, zoom, models, output_path):
    ...
    if not zoom.empty:
        fig.add_vrect(
            ...
            annotation_text="Apr 13-17", annotation_position="top left",
            annotation_font_color=GOLD, annotation_font_size=10,
            row=1, col=1,
        )

    # ────────────────────────────────────────
    # Panel 2: Zoom Apr 13-17
    # ────────────────────────────────────────
    if not zoom.empty:
        fig.add_trace(
            go.Scatter(
        ...
        fig.add_annotation(
            text="No data for Apr 13-17, 2026",
    ...
    # Determine row colors for table
...
def main():
    ...
    output_path = os.path.join(output_dir, "..", "output", "garch_dashboard.html")
